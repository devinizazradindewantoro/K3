...
<div class="card card-outline card-danger">
    ...
    <div class="card-body">
        <p style="text-align: justify;">
            PT HM Sampoerna Tbk. memiliki peraturan K3 yang mencakup kepatuhan terhadap peraturan perundang-undangan, 
            pencegahan kecelakaan dan penyakit kerja, serta pencegahan polusi lingkungan. 
            Peraturan ini bertujuan untuk memastikan keselamatan, kesehatan, dan kesejahteraan seluruh pekerja serta menjaga lingkungan kerja yang aman.
        </p>

        <h5 class="mt-3">1. Kebijakan dan Komitmen</h5>
        ...
        <h5 class="mt-3">2. Prosedur K3</h5>
        <ul style="text-align: justify;">
            <li>
        ...
        <p class="text-muted"><small>
            Dokumen ini merupakan bagian dari kebijakan K3 PT HM Sampoerna Tbk. 
            Harap setiap pekerja dan mitra perusahaan mematuhi seluruh ketentuan dan prosedur yang telah ditetapkan.
        </small></p>
    </div>
</div>
@endsection
